                                ...
                                <div class="login-form">
                                    ...
                                    <form class="user" @submit.prevent="searchDate" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <label for="exampleFormControlTextareaDetails"><b>Search By Date</b></label>
                                                    <input type="date" class="form-control" required id="exampleInputcategory_name" v-model="date">
                                                </div>
                                            </div>
                                        </div>
