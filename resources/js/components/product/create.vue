                                    ...
                                    <form class="user" @submit.prevent="productInsert" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" v-model="form.supplier_id">
                                                        <option :value="supplier.id" :key="supplier.id" v-for="supplier in suppliers">
                                                            {{ supplier.name }}
                                                        </option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="exampleInputjoining_joining_date" v-model="form.buying_date">
                                                    <small class="text-danger" v-if="errors.buying_date"> {{ errors.buying_date[0] }} </small>
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="exampleFormControlSelect1">Product Quantity</label>
                                                    <input type="text" class="form-control" id="exampleInputNid" v-model="form.product_quantity">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <img :src="form.image" alt="Error" style="height: 40px; width: 40px;">
                                                </div>
                                            </div>
                                        </div>
